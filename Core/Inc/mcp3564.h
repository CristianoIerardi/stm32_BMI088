...
#include "main.h"
 ...
 /* Private defines -----------------------------------------------------------*/
#define MCP3561_CHIP_SELECT_GPIO_Pin  (SPI2_CS_Pin)
#define MCP3561_CHIP_SELECT_GPIO_Port (SPI2_CS_GPIO_Port)
...
#define MCP3561_IRQ_MODE_IRQ_HIGH   (1 << _MCP3561_IRQ_MODE_POS)
 #define MCP3561_IRQ_MODE_IRQ_LOW 	(3 << _MCP3561_IRQ_MODE_POS)	// Added by user
#define MCP3561_IRQ_FASTCMD_ON      (1 << 1)
 //#define MCP3561_IRQ_EN_STP_CHID_MODE (1<<6) // <--- To enable channels ID in status byte register
...
/* for the conversion ADC - VOLTAGE*/
#define VREF_VOLTAGE_V    3.3      	// Referement tension (Vref+ - Vref-)
#define ADC_GAIN          1.0      	// Gain of ADC
#define ADC_MAX_COUNT     8388608.0 // 2^23 --> 24 bit signed
/*----------------------------------*/
